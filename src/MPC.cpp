...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    // SDG: remember here to sum the cost for all time steps
    for (int t = 0; t < N; t++) {
    ...
    // SDG: add this as a sort of regularization term
    // SDG: why is this to N-1?
    ...
    // SDG: penalize abrupt changes in actuation
    ...
    for (int t = 1; t < N; t++) {
      ...
      AD<double> fpx0 = coeffs[1];
      AD<double> psides0 = CppAD::atan(fpx0);
